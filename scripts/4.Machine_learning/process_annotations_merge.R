...
table(train_df$coarse_label)
table(test_df$coarse_label)

# substitute neutral with positive
train_df$coarse_label[train_df$coarse_label == "neutral"] <- "positive"
test_df$coarse_label[test_df$coarse_label == "neutral"] <- "positive"
